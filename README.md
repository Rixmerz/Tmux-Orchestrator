...
- Sends "--continue" + Enter to all Claude windows via send-claude-message.sh
...
4. When time arrives, sends "--continue" to all Claude sessions via send-claude-message.sh
